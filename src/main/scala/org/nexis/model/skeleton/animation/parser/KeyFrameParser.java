...
package org.nexis.model.skeleton.animation.parser;
...
public class KeyFrameParser extends Parser {
	...
	public static class KeyFrameContext extends ParserRuleContext {
		public org.nexis.model.skeleton.animation.ParsedKeyFrame result;
	...
	public final KeyFrameContext keyFrame() throws RecognitionException {
		...
		try {
			...
			setState(22);
			match(T__1);
			 ((KeyFrameContext)_localctx).result =  new org.nexis.model.skeleton.animation.ParsedKeyFrame( l.toArray( new org.nexis.model.skeleton.animation.ParsedJointAngles[0]) ); 
			}
		}
	...
	public static class JointContext extends ParserRuleContext {
		public org.nexis.model.skeleton.animation.ParsedJointAngles r;
		public Token n;
	...
	public final JointContext joint() throws RecognitionException {
		...
		try {
			...
			((JointContext)_localctx).a = angles();
			 ((JointContext)_localctx).r =  new org.nexis.model.skeleton.animation.ParsedJointAngles( (((JointContext)_localctx).n!=null?((JointContext)_localctx).n.getText():null), ((JointContext)_localctx).a.r ); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class AnglesContext extends ParserRuleContext {
		public org.nexis.model.skeleton.animation.ParsedJointAngle[] r;
	...
	public final AnglesContext angles() throws RecognitionException {
		...
		try {
			...
			setState(43);
			match(T__1);
			 ((AnglesContext)_localctx).r =  l.toArray(new org.nexis.model.skeleton.animation.ParsedJointAngle[0]); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final AngleContext angle() throws RecognitionException {
		...
		try {
			...
			((AngleContext)_localctx).v = floatNum();
			 ((AngleContext)_localctx).r =  new org.nexis.model.skeleton.animation.ParsedJointAngle(org.nexis.math.Axis.valueOf((((AngleContext)_localctx).a!=null?((AngleContext)_localctx).a.getText():null)), ((AngleContext)_localctx).v.r); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
