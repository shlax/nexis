...
package org.nexis.model.parser;
...
public class ModelParser extends Parser {
	...
	public static class ModelContext extends ParserRuleContext {
		public org.nexis.model.ParsedModel result;
	...
	public final ModelContext model() throws RecognitionException {
		...
		try {
			...
			((ModelContext)_localctx).t = triangles();
			 ((ModelContext)_localctx).result =  new org.nexis.model.ParsedModel( ((ModelContext)_localctx).p.r.toArray(new org.nexis.math.Vector3f[0] ), ((ModelContext)_localctx).t.r.toArray( new org.nexis.model.ParsedTriangle[0] ) ); 
			}
		}
	...
	public static class TrianglesContext extends ParserRuleContext {
		public java.util.List<org.nexis.model.ParsedTriangle> r;
	...
	public final TrianglesContext triangles() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			 ((TrianglesContext)_localctx).r =  new java.util.ArrayList<org.nexis.model.ParsedTriangle>(); 
			setState(26);
			match(T__1);
			setState(27);
	...
	public static class TriangleContext extends ParserRuleContext {
		public org.nexis.model.ParsedTriangle r;
	...
	public final TriangleContext triangle() throws RecognitionException {
		...
		try {
			...
			setState(43);
			match(T__2);
			 ((TriangleContext)_localctx).r =  new org.nexis.model.ParsedTriangle(((TriangleContext)_localctx).a.r, ((TriangleContext)_localctx).b.r, ((TriangleContext)_localctx).c.r); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class VertexContext extends ParserRuleContext {
		public org.nexis.model.ParsedVertex r;
	...
	public final VertexContext vertex() throws RecognitionException {
		...
		try {
			...
			((VertexContext)_localctx).u = uvs();
			 ((VertexContext)_localctx).r =  new org.nexis.model.ParsedVertex(((VertexContext)_localctx).i.r, ((VertexContext)_localctx).n.r, ((VertexContext)_localctx).u.r.toArray( new org.nexis.math.Vector2f[0] ) ); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class UvsContext extends ParserRuleContext {
		public java.util.List<org.nexis.math.Vector2f> r;
	...
	public static class PointsContext extends ParserRuleContext {
		public java.util.List<org.nexis.math.Vector3f> r;
	...
	public static class Vector2Context extends ParserRuleContext {
		public org.nexis.math.Vector2f r;
		public FloatNumContext a;
		public FloatNumContext b;
		public List<FloatNumContext> floatNum() {
			return getRuleContexts(FloatNumContext.class);
	...
	public final Vector2Context vector2() throws RecognitionException {
		...
		try {
			...
			setState(95);
			match(T__5);
			 ((Vector2Context)_localctx).r =  new org.nexis.math.Vector2f(((Vector2Context)_localctx).a.r, ((Vector2Context)_localctx).b.r); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
